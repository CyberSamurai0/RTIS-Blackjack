...
let intsToggle = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        container.style.backgroundImage = "url(/blackjack/static/TRAFFIC_TOGGLE_ICON.png)"
...
let BSMToggle = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        container.style.backgroundColor = 'white'
        container.style.backgroundImage = "url(/blackjack/static/CAR_ICON.png)"
        container.style.backgroundRepeat = "no-repeat"
        container.style.backgroundSize = "30px 30px";
...
const trafficIcon = L.icon({
    iconUrl: "/blackjack/static/TRAFFIC_ICON.png",
    iconSize: [16, 40],
    iconAnchor: [8, 20],
});
